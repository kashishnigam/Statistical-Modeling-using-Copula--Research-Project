...
file_path <- "C:/Users/KASHISH NIGAM/Desktop/Last Sem Project/Final Datasets/USA/uniform_distributions-Post_Covid_USA.xlsx"

# Load the data from the Excel file
Post_covid_USA <- read_excel(file_path)

# Convert the data to a matrix (if not already in matrix form)
u_data <- as.matrix(Post_covid_USA)
...
pearson_rho <- cor(Post_covid_USA, method = "pearson")

# Compute Kendall's tau
kendall_tau <- cor(Post_covid_USA, method = "kendall")
